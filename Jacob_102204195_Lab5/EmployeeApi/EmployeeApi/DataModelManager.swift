...
import Foundation
class JSONManager{
    func fetchJSONData(completionHandler : @escaping ([Employee]) -> Void) {


          let url = URL(string: "https://raw.githubusercontent.com/jacob-johar/EmployeeData/main/employee_data")!
                 ...
                 let task = URLSession.shared.dataTask(with: url) { (data, response, error) in
                     ...
                     if let mimeType = httpResponse.mimeType,
                         ...
                         do {
                             ...
                             let result = try decoder.decode([Employee].self, from: data)
